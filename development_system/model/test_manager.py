...
class TestManager:
    ...
    def __init__(self):
        ...
        winner_path_from_root = os.getenv("WINNER_PATH")
        self.winner_path = Path(__file__).resolve().parents[2] / winner_path_from_root
        ...
        read_result, file_content = JsonReadWrite.read_json_file(self.winner_path)
        if not read_result:
